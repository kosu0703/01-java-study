...
public class Ex18 {
	public static void main(String[] args) {
		...
		// 날짜 관련 클래스 ( Date 클래스, Calendar 클래스, LocalDate 클래스 )
		...
		// 년, 월, 일, 시, 분, 초, 요일 // 시작점 1900년 1월 1일 0시 0분 0초
		// **시스템상의 년,월,일,시,분,초
		System.out.println(date.getYear()); // 현재년도 - 1900 = 123
		System.out.println(date.getYear() + 1900 + "년");
		System.out.println(date.getMonth());// 월은 0 부터 11 까지
		...
		int k = date.getDay(); // 요일은 0 부터 6 까지 ( 0 일요일 , 1 월요일 , ... , 6 토요일 )
		switch (k) {
		case 0:
