...
//			contentPane.setLayout(new CardLayout(0, 0));
		...
		private boolean connected() {
			boolean value = true;
			try {
				s = new Socket("192.168.0.36", 7009);
		...
		public void run() {
			bk:while(true) {
				try {
					//	서버에서 온거 받기
					//	올때는 1번(로그인)이 2번(대화)으로 바껴서 1번은 없다.
					//	따라서 0번(종료) 또는 2번(대화) 만 설정
		...
		public static void main(String[] args) {
			//	AWT 에서 제공하는(관리하는) 특별한 스레드 처리 방식
